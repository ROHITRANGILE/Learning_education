...
<!-- Navigation Bar -->
	<header id="header">
		<nav>
			...
			<a class="get-started" href="login_page/login.php">Login</a>
		...
		<div class="head-container">
			<div class="quote">
				...
				<div class="play">
					<img src="images/icon/play.png" alt="play"><span><a href="https://youtu.be/cUnayHxk-Rs?si=wFFND3v40Z3v0BjN" target="_blank">Watch Now</a></span>
				</div>
			</div>
			<div class="svg-image">
...
<!-- FEEDBACK -->
	...
	<div class="feedbox">
		<div class="feed">
			<form action="user_database/feedback_data.php" method="post">
		...
		<div class="footer-container">
			<div class="left-col">
				...
				<div class="social-media">
					<a href="https://www.facebook.com/intellipaatonline/"><img src="images/icon\fb.png"></a>
					<a href="https://www.instagram.com/intellipaat/?hl=en"><img src="images/icon\insta.png"></a>
					<a href="https://x.com/Intellipaat/status/1873647799210025442"><img src="images/icon\tt.png"></a>
					<a href="https://www.youtube.com/@Intellipaat"><img src="images/icon\ytube.png"></a>
					<a href="https://www.linkedin.com/company/intellipaat-software-solutions/?originalSubdomain=in"><img src="images/icon\linkedin.png"></a>
				</div><br><br>
				<p class="rights-text">Copyright © 2025 Created By Rohit Rangile All Rights Reserved.</p>
				<br><p><img src="images/icon/location.png">Location:- KIPS College ,<br>Khandwa, Madhya Pradesh -450001</p><br>
				<p><img src="images/icon/phone.png"> +91-1234-567-890<br><img src="images/icon/mail.png">&nbsp; rohitrangile81@gmail.com</p>
			</div>
			<div class="right-col">
